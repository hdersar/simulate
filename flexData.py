...
def astra_proj_geom(geometry, data_shape, index_first = None, index_last = None):
    ...
    #proj_geom = astra.create_proj_geom('cone', magnification, magnification, det_count_z, det_count_x, thetas, (src2obj * magnification)/det_pixel, (det2obj * magnification)/det_pixel)
...
def create_geometry(src2obj, det2obj, det_pixel, theta_range, theta_count, endpoint=True):
    """
    ...
    geometry['thetas'] = numpy.linspace(theta_range[0], theta_range[1], theta_count, endpoint=endpoint, dtype = 'float32') 
